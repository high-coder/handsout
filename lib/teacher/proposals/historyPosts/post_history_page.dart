...
class SubmittedHistory extends StatefulWidget {
  const SubmittedHistory({Key? key}) : super(key: key);

  @override
  _SubmittedHistoryState createState() => _SubmittedHistoryState();
}

class _SubmittedHistoryState extends State<SubmittedHistory> {
  ...
  void initState() {
    ...
    data = _instance.fetchAppliedPosts("none");
                ...
                builder: (context, snapshot) {
                  switch (snapshot.connectionState) {
                    ...
                    case ConnectionState.done:
                      if (_instance.interestedPosts.isNotEmpty) {
                        return ListView.builder(
                            physics: const NeverScrollableScrollPhysics(),
                            shrinkWrap: true,
                            itemCount: _instance.interestedPosts.length,
                                      ...
                                      Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Flexible(
                                                child: Text(
                                                  _instance.interestedPosts[index].title,
                                            ...
                                            Flexible(
                                              child: Text("Deadline ${_instance.interestedPosts[index].deadLine.day} /${_instance.interestedPosts[index].deadLine.month} /${_instance.interestedPosts[index].deadLine.year}",
                                            ...
                                            Flexible(
                                              child: Text(
                                                _instance.interestedPosts[index].description,
                                                maxLines: 7,
                                              ),
                                            ),
                                            SizedBox(height: 10,),
                                            Flexible(
                                                child: Text(
                                                  "Tags : ${_instance.interestedPosts[index]
                                                      .hashTags}",
